#coding=utf-8
import sys
sys.path.append("/home/cqq/repos/vulscan-master/apktool")  #不加这一句就找不到tools.modified.androguard.core模块
...
class APK(object):
    ...
    def get_dex(self, file="classes.dex"):   # modified by cqq
        """
...
#################################################################################################
# 从https://github.com/androguard/androguard/blob/master/androguard/core/bytecodes/apk.py 粘贴过来的
